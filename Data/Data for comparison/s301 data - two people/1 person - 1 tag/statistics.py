...
frames = pd.read_csv('/home/oskar/Documents/Master Thesis/Data/Data for comparison/s301 data - two people/1 person - 1 tag/uwb_to_bb_mapping.txt', sep=' ', header=None, usecols=[0])
frames.columns = ['Frames']

# Load the reference coordinates
ref_coords_path = '/home/oskar/Documents/Master Thesis/Data/Data for comparison/s301 data - two people/1 person - 1 tag/reference_coordinates.txt'
ref_coords = pd.read_csv(ref_coords_path, sep=' ', header=None)
ref_coords.columns = ['x', 'y']

# Load estimated coordinates
uwb_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Data/Data for comparison/s301 data - two people/1 person - 1 tag/uwb_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
uwb_coords.columns = ['x', 'y']

optical_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Data/Data for comparison/s301 data - two people/1 person - 1 tag/optical_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
optical_coords.columns = ['x', 'y']

model_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Data/Data for comparison/s301 data - two people/1 person - 1 tag/pixel_to_real_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
