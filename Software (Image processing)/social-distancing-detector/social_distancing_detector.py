...
ap.add_argument("-i", "--input", type=str, default="vlc-record-2022-08-02-16h24m14s.mp4", help="path to (optional) input video file")
ap.add_argument("-o", "--output", type=str, default="output.mp4", help="path to (optional) output video file")
