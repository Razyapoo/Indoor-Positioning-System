...
class TKinterCameraStream(tk.Frame):
    ...
    def setupUI(self):
        #create a header
        self.header = tk.Label(self, text="Camera Stream", bg="black", fg="white")
...
class TKinterStreamLog(tk.Frame):
    ...
    def setupUI(self):
        ...
        self.textArea = st.ScrolledText(self.root, width = 70, height = 15, font = ("Times New Roman", 10))
...
class TKinterComparisonFrame(tk.Frame):
    ...
    def setupUI(self):
        ...
        self.updateDistanceVideo()
        self.updateDistanceUwb()
    
    def updateDistanceVideo(self, dist=0):
        self.distanceVideo = tk.Label(self, text=dist)
        self.distanceVideo.grid(row=1, column=1)
    
    def updateDistanceUwb(self, dist=0):
        self.distanceUwb = tk.Label(self, text=dist)
...
class AppGUI():
    def __init__(self):
        ...
        self.tkinterCameraStream = TKinterCameraStream(self.root)
        self.tkinterCameraStream.grid(row=0, column=0, sticky='n', padx=10, pady=10)
        ...
        self.tkinterVideoStreamLogTopLevel = TKinterStreamLogTopLevel(self.root)
        ...
        self.tkinterUwbServerStreamLogTopLevel = TKinterStreamLogTopLevel(self.root)
    ...
    def updateOutputFrame(self, frame=None, videoDistance=0, uwbDataJSON=""):
        ...
        if not frame is None :
            ...
            self.tkinterCameraStream.updateFrame(frame)
        ...
        if uwbDataJSON:
            ...
            try:
                ...
                uwbDataJSON = ""
                uwbData = ""
            # self.tkinterUwbServerStream.updateTextArea(uwbData)
            # self.comparisonFrame.updateDistanceUwb(uwbDistance)
