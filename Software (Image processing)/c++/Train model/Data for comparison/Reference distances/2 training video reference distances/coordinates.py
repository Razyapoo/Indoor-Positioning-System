...
reference_df.to_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/2 training video reference values/reference_coordinates.txt', index=False, sep=' ', header=False)
