...
uwb_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/s1 data - three people/1 person/uwb_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
uwb_coords.columns = ['x', 'y']

optical_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/s1 data - three people/1 person/optical_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
optical_coords.columns = ['x', 'y']

model_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/s1 data - three people/1 person/pixel_to_real_to_bb_mapping.txt', sep=' ', header=None, usecols=[3, 4])
