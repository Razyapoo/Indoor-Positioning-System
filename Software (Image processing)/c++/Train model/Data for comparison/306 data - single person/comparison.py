...
frames = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/306 data - single person/uwb_to_bb_mapping_entire.txt', sep=' ', header=None, usecols=[0])
frames.columns = ['Frames']

# Load the reference coordinates
ref_coords_path = '/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/306 data - single person/reference_coordinates.txt'
ref_coords = pd.read_csv(ref_coords_path, sep=' ', header=None)
ref_coords.columns = ['x', 'y']

uwb_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/306 data - single person/uwb_to_bb_mapping_entire.txt', sep=' ', header=None, usecols=[3, 4])
uwb_coords.columns = ['x', 'y']

optical_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/306 data - single person/optical_to_bb_mapping_entire.txt', sep=' ', header=None, usecols=[3, 4])
optical_coords.columns = ['x', 'y']

model_coords = pd.read_csv('/home/oskar/Documents/Master Thesis/Software (Image processing)/c++/Train model/Data for comparison/306 data - single person/pixel_to_real_to_bb_mapping_entire.txt', sep=' ', header=None, usecols=[3, 4])
...
plt.plot(uwb_coords['x'], uwb_coords['y'], color='green', label='UWB Estimated Coordinates')
...
plt.plot(model_coords['x'], model_coords['y'], color='orange', label='Pixel-to-Real Estimated Coordinates')
...
plt.plot(optical_coords['x'], optical_coords['y'], color='red', label='Optical Estimated Coordinates')
