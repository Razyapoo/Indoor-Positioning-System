...
# plt.scatter(ref_coords['x'], ref_coords['y'], color='blue', label='Reference Coordinates', s=10)
# # plt.scatter(uwb_coords['x'], uwb_coords['y'], color='red', label='UWB Estimated Coordinates', s=10)
# # plt.scatter(optical_coords['x'], optical_coords['y'], color='green', label='Optical Estimated Coordinates', s=10)
# plt.scatter(model_coords['x'], model_coords['y'], color='orange', label='Model Estimated Coordinates', s=10)

# plt.xlabel('X Coordinate')
# plt.ylabel('Y Coordinate')
# plt.title('Reference and Estimated Coordinates')
# plt.legend()
# plt.grid(True)
# plt.show()
...
errors_df = pd.DataFrame({
    ...
    'PixelToReal_x_Error': np.abs(ref_coords['x'] - model_coords['x']),
    'PixelToReal_y_Error': np.abs(ref_coords['y'] - model_coords['y']),
...
# plt.title('Boxplot of Errors by Method and Axis')
...
# plt.subplot(3, 2, 1)
# plt.hist(errors_df['UWB_x_Error'], bins=50, alpha=0.7, color='blue')
# plt.title('Histogram of UWB X Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
# plt.title('Histogram of UWB Y Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
# plt.subplot(3, 2, 3)
# plt.hist(errors_df['PixelToReal_x_Error'], bins=50, alpha=0.7, color='red')
# plt.title('Histogram of PixelToReal X Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
# plt.subplot(3, 2, 4)
# plt.hist(errors_df['PixelToReal_y_Error'], bins=50, alpha=0.7, color='orange')
# plt.title('Histogram of PixelToReal Y Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
# plt.title('Histogram of Optical X Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
# # Histogram for Optical_Y_Error
# plt.subplot(3, 2, 6)
# plt.hist(errors_df['Optical_y_Error'], bins=50, alpha=0.7, color='orange')
# plt.title('Histogram of Optical Y Errors')
# plt.xlabel('Absolute Error')
# plt.ylabel('Frequency')
# plt.grid(True)
...
errors_df['PixelToReal_x_Error_MA'] = errors_df['PixelToReal_x_Error'].rolling(window=window_size).mean()
errors_df['PixelToReal_y_Error_MA'] = errors_df['PixelToReal_y_Error'].rolling(window=window_size).mean()
...
# plt.xlabel('Frame')
# plt.ylabel('Absolute Error')
# plt.title('Pixel To Real X Error Trend')
# plt.legend()
# plt.grid(True)
...
# plt.xlabel('Frame')
# plt.ylabel('Absolute Error')
# plt.title('Pixel To Real Y Error Trend')
# plt.legend()
# plt.grid(True)
...
# plt.xlabel('Frame')
# plt.ylabel('Absolute Error')
# plt.title('Optical X Error Trend')
# plt.legend()
# plt.grid(True)
...
# plt.xlabel('Frame')
# plt.ylabel('Absolute Error')
# plt.title('Optical Y Error Trend')
# plt.legend()
# plt.grid(True)
...
distance_metrics = {
    'Method': ['UWB', 'Optical'],
    'Mean Distance': [distance_errors['UWB_Distance'].mean(), distance_errors['Optical_Distance'].mean()],
    'Median Distance': [distance_errors['UWB_Distance'].median(), distance_errors['Optical_Distance'].median()],
    'Max Distance': [distance_errors['UWB_Distance'].max(), distance_errors['Optical_Distance'].max()],
    'Min Distance': [distance_errors['UWB_Distance'].min(), distance_errors['Optical_Distance'].min()],
    'Std Dev Distance': [distance_errors['UWB_Distance'].std(), distance_errors['Optical_Distance'].std()]
}
...
distance_data = pd.melt(distance_errors, value_vars=['UWB_Distance', 'Optical_Distance'], var_name='Method', value_name='Distance')
...
plt.figure(figsize=(14, 6))
plt.scatter(errors_df['Frames'], distance_errors['UWB_Distance'], alpha=0.5, label='UWB Distance', color='blue')
plt.scatter(errors_df['Frames'], distance_errors['Optical_Distance'], alpha=0.5, label='Optical Distance', color='red')
plt.title('Scatter Plot of UWB and Optical Distances')
plt.xlabel('Frames')
plt.ylabel('Distance')
plt.legend()
plt.grid(True)
...
# Density Plot: Distribution of UWB and Optical distances
plt.figure(figsize=(14, 6))
sns.kdeplot(distance_errors['UWB_Distance'], label='UWB Distance', fill=True, color='blue')
sns.kdeplot(distance_errors['Optical_Distance'], label='Optical Distance', fill=True, color='red')
plt.title('Density Plot of UWB and Optical Distances')
plt.xlabel('Distance')
plt.ylabel('Density')
plt.legend()
plt.grid(True)
