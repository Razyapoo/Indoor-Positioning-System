...
float Disparity::disparityMultiplier = 1.0f;
bool Disparity::showColored = false;
bool Disparity::applyFilter = false;
...
void Disparity::init(const std::string& intrinsicFilePath, const std::string& extrinsicFilePath, const std::string& rectificationFilePath) {
