...
int main()
{
    ...
    const double A4_WIDTH = 420; // in millimeters
    ...
    const int MARGIN_SIZE = 10; // in pixels
    ...
    const double LEFT_MARGIN = 0; // in millimeters
    const double TOP_MARGIN = 0; // in millimeters
    const double RIGHT_MARGIN = 0; // in millimeters
    const double BOTTOM_MARGIN = 0; // in millimeters
